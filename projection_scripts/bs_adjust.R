...
dupe_base<-which(duplicated(bs_base[,2:114])) # this is 0 for the large 15k samples, the geographies are different within cohorts (e.g. comparing 2025 and 2030)
if (length(dupe_base)>0) {bs_base<-bs_base[!duplicated(bs_base[,2:114]),]}
...
dupe_baseDE<-which(duplicated(bs_baseDE[,2:114]))
if (length(dupe_baseDE)>0) {bs_baseDE<-bs_baseDE[!duplicated(bs_baseDE[,2:114]),]}
...
dupe_baseRFA<-which(duplicated(bs_baseRFA[,2:114]))
if (length(dupe_baseRFA)>0) {bs_baseRFA<-bs_baseRFA[!duplicated(bs_baseRFA[,2:114]),]}
...
dupe_baseDERFA<-which(duplicated(bs_baseDERFA[,2:114]))
if (length(dupe_baseDERFA)>0) {bs_baseDERFA<-bs_baseDERFA[!duplicated(bs_baseDERFA[,2:114]),]}
...
dupe_hiDR<-which(duplicated(bs_hiDR[,2:114]))
# bs_hiDR<-bs_hiDR[!duplicated(bs_hiDR[,2:114]),]
...
dupe_hiDRDE<-which(duplicated(bs_hiDRDE[,2:114]))
# bs_hiDRDE<-bs_hiDRDE[!duplicated(bs_hiDRDE[,2:114]),]
...
dupe_hiDRRFA<-which(duplicated(bs_hiDRRFA[,2:114]))
# bs_hiDRRFA<-bs_hiDRRFA[!duplicated(bs_hiDRRFA[,2:114]),]
...
dupe_hiDRDERFA<-which(duplicated(bs_hiDRDERFA[,2:114]))
# bs_hiDRDERFA<-bs_hiDRDERFA[!duplicated(bs_hiDRDERFA[,2:114]),]
...
dupe_hiMF<-which(duplicated(bs_hiMF[,2:114]))
# bs_hiMF<-bs_hiMF[!duplicated(bs_hiMF[,2:114]),]
...
dupe_hiMFDE<-which(duplicated(bs_hiMFDE[,2:114]))
# bs_hiMFDE<-bs_hiMFDE[!duplicated(bs_hiMFDE[,2:114]),]
...
dupe_hiMFRFA<-which(duplicated(bs_hiMFRFA[,2:114]))
# bs_hiMFRFA<-bs_hiMFRFA[!duplicated(bs_hiMFRFA[,2:114]),]
...
dupe_hiMFDERFA<-which(duplicated(bs_hiMFDERFA[,2:114]))
# bs_hiMFDERFA<-bs_hiMFDERFA[!duplicated(bs_hiMFDERFA[,2:114]),]
...
bs_base_sim<-rm_dot2(bs_base[,1:114])
bs_baseDE_sim<-rm_dot2(bs_baseDE[,1:114])
bs_baseRFA_sim<-rm_dot2(bs_baseRFA[,1:114])
bs_baseDERFA_sim<-rm_dot2(bs_baseDERFA[,1:114])

bs_hiDR_sim<-rm_dot2(bs_hiDR[,1:114])
bs_hiDRDE_sim<-rm_dot2(bs_hiDRDE[,1:114])
bs_hiDRRFA_sim<-rm_dot2(bs_hiDRRFA[,1:114])
bs_hiDRDERFA_sim<-rm_dot2(bs_hiDRDERFA[,1:114])

bs_hiMF_sim<-rm_dot2(bs_hiMF[,1:114])
bs_hiMFDE_sim<-rm_dot2(bs_hiMFDE[,1:114])
bs_hiMFRFA_sim<-rm_dot2(bs_hiMFRFA[,1:114])
bs_hiMFDERFA_sim<-rm_dot2(bs_hiMFDERFA[,1:114])

# then save them
write.csv(bs_base_sim,file='../scen_bscsv_sim/bs_base.csv', row.names = FALSE)
write.csv(bs_baseDE_sim,file='../scen_bscsv_sim/bs_baseDE.csv', row.names = FALSE)
write.csv(bs_baseRFA_sim,file='../scen_bscsv_sim/bs_baseRFA.csv', row.names = FALSE)
write.csv(bs_baseDERFA_sim,file='../scen_bscsv_sim/bs_baseDERFA.csv', row.names = FALSE)

write.csv(bs_hiDR_sim,file='../scen_bscsv_sim/bs_hiDR.csv', row.names = FALSE)
write.csv(bs_hiDRDE_sim,file='../scen_bscsv_sim/bs_hiDRDE.csv', row.names = FALSE)
write.csv(bs_hiDRRFA_sim,file='../scen_bscsv_sim/bs_hiDRRFA.csv', row.names = FALSE)
write.csv(bs_hiDRDERFA_sim,file='../scen_bscsv_sim/bs_hiDRDERFA.csv', row.names = FALSE)

write.csv(bs_hiMF_sim,file='../scen_bscsv_sim/bs_hiMF.csv', row.names = FALSE)
write.csv(bs_hiMFDE_sim,file='../scen_bscsv_sim/bs_hiMFDE.csv', row.names = FALSE)
write.csv(bs_hiMFRFA_sim,file='../scen_bscsv_sim/bs_hiMFRFA.csv', row.names = FALSE)
