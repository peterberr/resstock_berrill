...
# Purpose: Define Characteristics of New Housing for all stock scenarios, including RFA and DE new housing characteristics variants

# Inputs: - Windows.tsv (all inputs are from project_national/housing_characteristics/)
#         - Ducts.tsv
#         - Geometry Building Number Units HL.tsv
#         - Geometry Garage.tsv
#         - HVAC Cooling Efficiency.tsv
#         - HVAC Has Shared System.tsv
#         - HVAC Heating Type.tsv
#         - HVAC Cooling Type.tsv
#         - Heating Fuel.tsv
#         - Hot Water Distribution.tsv
#         - Infiltration.tsv
#         - Insulation Crawlspace.tsv
#         - Insulation Finished Basement.tsv
#         - Insulation Interzonal Floor.tsv
#         - Insulation Pier Beam.tsv
#         - Insulation Slab.tsv
#         - Insulation Unfinished Attic.tsv
#         - Insulation Unfinished Basement.tsv
#         - Insulation Wall.tsv
#         - Insulation Finished Roof
#         - Geometry Floor Area.tsv
#         - Geometry Foundation Type.tsv
#         - Geometry Stories.tsv
#         - Water Heater In Unit.tsv
#         - Clothes Dryer.tsv
#         - Clothes Washer.tsv
#         - Lighting.tsv
#         - Water Heater Efficiency.tsv
#         - Water Heater Fuel.tsv
#         - Refrigerator.tsv
#         - HVAC Heating Type and Fuel.tsv
#         - HVAC Heating Efficiency.tsv
#         - HVAC Has Zonal Electric Heating.tsv
#         - Cooking Range.tsv
#         - Vacancy Status.tsv
#         - Lighting.tsv
#         - Lighting.tsv
...
# Outputs: 
#         - Corresponding files that were input and modified to reflect updated housing and appliance characteristics in new housing, for every five years in each stock scenario, including DE and RFA variants
...
# then save the new cooling efficiency file complete with new characteristics
...
# then save the new hvac cooling file complete with new characteristics
...
# now save the new heat fuel files complete with new characteristics
...
# then save the new infiltration file complete with new characteristics
...
# then save the new incr file complete with new characteristics
...
# then save the new infb file complete with new characteristics
