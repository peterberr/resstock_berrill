...
ggplot(df,aes(x=Year,y=1e-6*Count,fill=HeatFuel))+geom_bar(position="stack", stat="identity") + scale_y_continuous(labels = scales::comma) + theme_bw() + 
  labs(title = "Pre-2020 housing units by main heat fuel, 2020-2060", y = "Million Housing Units",subtitle = paste(scenario_names[sts], ", Advanced Renovation",sep=""))
...
ggplot(wfe,aes(x=Year,y=1e-6*Count,fill=WaterFuel_Efficiency))+geom_bar(position="stack", stat="identity") + scale_y_continuous(labels = scales::comma) + theme_bw() + scale_fill_manual(values = cols)+
  labs(title = "Pre-2020 housing units by main water heating system, 2020-2060", y = "Million Housing Units",subtitle = paste(scenario_names[sts], ", Advanced Renovation",sep=""))
...
ggplot(hfe_el,aes(x=Year,y=1e-6*Count,fill=HeatEfficiency))+geom_bar(position="stack", stat="identity") + scale_y_continuous(labels = scales::comma)+ theme_bw() +scale_fill_manual(values = cols) +
  labs(title = "Electric heating systems by equipment type and efficiency, 2020-2060",  y = "Million Housing Units",subtitle = paste(scenario_names[sts], ", Advanced Renovation",sep=""))
...
ggplot(hfe_gas,aes(x=Year,y=1e-6*Count,fill=HeatEfficiency))+geom_bar(position="stack", stat="identity") + scale_y_continuous(labels = scales::comma) + theme_bw()  + scale_fill_manual(values = cols) +
  labs(title = "Gas heating systems by equipment type and efficiency, 2020-2060",  y = "Million Housing Units",subtitle = paste(scenario_names[sts], ", Advanced Renovation",sep=""))
...
ggplot(hfe_oil,aes(x=Year,y=1e-6*Count,fill=HeatEfficiency))+geom_bar(position="stack", stat="identity") + scale_y_continuous(labels = scales::comma)+ theme_bw() + scale_fill_manual(values = cols) +
  labs(title = "Oil heating systems by equipment type and efficiency, 2020-2060",y = "Million Housing Units",subtitle = paste(scenario_names[sts], ", Advanced Renovation",sep=""))
...
save(df_base,df_hiDR,hfe_base,hfe_hiDR,ins_base,ins_hiDR,cte_base,cte_hiDR,wfe_base,wfe_hiDR,file="../Intermediate_results/AdvRenSummary.RData")